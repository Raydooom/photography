  ...
  <section id="articleList">
    <ul>
      <li v-for="item in arr">
        <div class="author">
          <span class="avatar"><img src="../assets/images/img.jpg" alt=""></span>
          <span class="name-wrap">
            <b><span>名字名字名</span><i>摄影大师</i></b>
            <i class="time">2018.12.23 23:12:12</i>
          </span>
        </div>
        <div class="main-wrap">
          <p>不清楚通过插件可不可以实现不清楚通过插件可不可以实现不清楚通过插件可不可以实现</p>
          <div class="photo-wrap">
            <div class="photos">
              <span><img src="../assets/images/img.jpg"></span>
              <span><img src="../assets/images/img.jpg"></span>
              <span><img src="../assets/images/img.jpg"></span>
              <span><img src="../assets/images/img.jpg"></span>
            </div>
        ...
        <div class="loc-show">天安门广场</div>
        <div class="handle-wrap">
          <b>浏览1000次</b>
          <span class="handle-btn praise">1</span>
          <span class="handle-btn comment">12</span>
          <span class="handle-btn share">12</span>
        </div>
      </li>
    </ul>
  </section>
